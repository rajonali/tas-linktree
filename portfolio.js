...
const greeting = {
  ...
  resumeLink:
    "https://github.com/rajonali/2021-resume/blob/main/resume.md",
...
const socialMediaLinks = {
  github: "https://github.com/rajonali",
  instagram: "https://instagram.com/tas.4li/",
  linkedin: "https://www.linkedin.com/in/rajonali1/",
  gmail: "rajonali44492@icloud.com",
...
const skillsSection = {
  title: "Who Am I?",
  subTitle: "A fullstack developer who is interested in combining his passion for security and development",
  skills: [
    emoji(
      "⚡ Develop highly front end solutions to streamline tasks"
    ),
...
const bigProjects = {
  ...
  projects: [
    {
      image: '/images/subr.svg',
      projectName: "ListedB",
      projectDesc: "An online community that connects beauty & wellness professionals, clients and enthusiasts.",
      footerLink: [
        {
          name: "Visit Website",
          url: "http://listedb.com/"
        }
...
const achievementSection = {
  ...
  achievementsCards: [
    {
      title: "2016 LHSRA Finalist",
      subtitle:
        "2nd Place in Computer Science II. Measures overall aptitude in networking, computer architecture, cryptology, and more.",
      image: '/images/subr.svg',
      footerLink: [
        {
          name: "Certification",
    ...
    {
      title: "Google IT Professional Course",
      subtitle:
        "Completed 6-month course ranging basic computer and network architecture, customer service, cryptology/encryption, data recovery, network security and a ton more. ",
      image: '/images/subr.svg',
      footerLink: [
        {
...
const contactInfo = {
  ...
  number: "+12252007900",
  email_address: "tasnim.ali@listedb.com"
};
